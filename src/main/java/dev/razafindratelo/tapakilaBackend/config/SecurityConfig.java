        ...
        return httpSec
                ...
                .authorizeHttpRequests(
                        auth -> auth
								...
								.requestMatchers(HttpMethod.GET, "/user/details/**").permitAll()
                                .requestMatchers(HttpMethod.GET,"/event-types-enum").permitAll()
                                .requestMatchers(HttpMethod.GET,"/event-categories").permitAll()
                                .requestMatchers(HttpMethod.GET, "/tickets-stats/**").permitAll()
                                .requestMatchers(HttpMethod.GET, "/events-turnover").permitAll()
                                .requestMatchers(HttpMethod.GET, "/events-turnover/**").permitAll()
                                .requestMatchers(HttpMethod.GET, "/event-turnover").permitAll()
